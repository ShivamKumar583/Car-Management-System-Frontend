...
const UserRegisterPage = () => {
    ...
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = (e) => {
        ...
        const response = disptach(Registration(formData));
  ...
  return (
    <div className="flex bg-gradient-to-r from-slate-100 via-slate-300 to-slate-500 text-sm font-mono items-center justify-center h-screen bg-gray-100">
      ...
      >
        <h1 className="text-2xl text-blue-600 font-bold text-center mb-4">Sign Up</h1>
        <p className="w-[100px] h-2 -mt-2 mx-auto rounded-full bg-gradient-to-r from-gray-100 to-blue-600"></p>

        <div className="mb-4">
          <label className="block text-blue-800 font-medium mb-1"> Name<sup className=' text-red-600'>*</sup></label>
          <input
            type="text"
            name="name"
        ...
        <p className=' w-full text-blue-600'>Already have an account? <a href='/login' className=' hover:underline hover:cursor-pointer'>Login</a></p>
        <button
